...
<div class="pull-right">
    ...
    <select id="pageSize" name="pageSize"
            onchange="changeTableSize('/clients/paymentDay/${paymentDay}', 'paymentDayClientsResultDiv', 'clientSearchForm');">
...
<div style="justify-content: center" class="row">
    ...
    <button class="btn btn-sm m-1 ${currentPage + 1 == totalPages || totalPages == 0 || totalPages == null ? 'btn-light disabled' : 'btn-primary'}" ${page + 1 == totalPages || totalPages == 0 ? 'disabled' : ''}
            onclick="nextPage('/clients/paymentDay/${paymentDay}', 'paymentDayClientsResultDiv', 'clientSearchForm')">
        التالي
    </button>

    <button class="btn btn-sm m-1
        ${currentPage == 0 || totalPages == 0 || currentPage == null || totalPages == null ? 'btn-light disabled' : 'btn-primary'}"
            onclick="previousPage('/clients/paymentDay/${paymentDay}', 'paymentDayClientsResultDiv', 'clientSearchForm')">
        السابق
    </button>
